```bash
# TiketAssignent
Inventory Management MVC with spring boot using Mysql , MongoDB and Redis server for cache
# Redis only implemented to (PartyMaster,ItemMaster and ItemGroupMaster)
...
#Reactive api added for stock (mongodb)

#For intercommunication between Mysql and mongodb controller i use webclient as restapi
